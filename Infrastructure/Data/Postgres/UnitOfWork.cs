...
public class UnitOfWork : IUnitOfWork
{
    ...
    public ITweetRepository TweetRepository => _tweetRepository ??= new TweetRepository(_postgresContext);

    public IFollowRepository FollowRepository => _followRepository ??= new FollowRepository(_postgresContext);
